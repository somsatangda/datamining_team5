...
<pre>
    (1) Sub-cluster 0 : 서대문구, 마포구, 영등포구, 동작구, 강남구
        - 노년층 규모가 크고, 안정적이고 충분한 돌봄 기반이 있는 지역
    (2) Sub-cluster 1 : 서초구
        - 위험 노인 비율이 낮고, 인프라도 안정적인 자립형 지역
    (3) Sub-cluster 2 : 용산구, 성동구
        - 인프라 부족 + 취약계층 집중 → 돌봄 우선 필요
</pre>
